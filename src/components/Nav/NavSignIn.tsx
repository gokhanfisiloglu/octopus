                            ...
                            <ul className="flex flex-col pl-0 mx-auto mb-0 list-none lg:flex-row xl:ml-auto">
                                <li>
                                    <a className="uppercase flex items-center px-4 py-2 mr-2 font-bold transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-text-xxs  lg:px-2
                                            text-gray-gray-700 leading-[150%]" aria-current="page" href="/dashboard">
                                        <img className={'text-gray-gray-700'} src={'/icon3.svg'}/>
                                        Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a className="uppercase flex items-center  px-4 py-2 mr-2 font-bold transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-text-xxs lg:px-2
                                            text-gray-gray-700 leading-[150%]" href="#">
                                        <img className={'text-gray-gray-700'} src={'/icon2.svg'}/>
                                        Profile
                                    </a>
                                </li>
                                <li>
                                    <a className="uppercase flex items-center  px-4 py-2 mr-2 font-bold transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-text-xxs lg:px-2
                                            text-gray-gray-700 leading-[150%]" href="/signup">
                                        <img className={'text-gray-gray-700'} src={'/icon1.svg'}/>
                                        Sign Up
                                    </a>
                                </li>
                                <li>
                                    <a className="uppercase flex items-center  px-4 py-2 mr-2 font-bold transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-text-xxs lg:px-2
                                            text-gray-gray-700 leading-[150%]" href="/signin">
                                        <img className={'text-gray-gray-700'} src={'/icon.svg'}/>
                                        Sign In
                                    </a>
                                </li>
                            </ul>
